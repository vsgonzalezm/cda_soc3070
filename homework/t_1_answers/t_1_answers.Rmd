...
- $\mathbb{P}(\text{Fair | T=RE1, W=1)}= \beta_{0} + \beta_{W} + \beta_{RE1}$


- $\mathbb{P}(\text{Fair | T=RE2, W=1)}= \beta_{0} + \beta_{W} + \beta_{RE2}$
...
$$\mathbb{P}(\text{Fair | T=RE1, W=1)}= \frac{1}{1 + e^{- (\beta_{0} + \beta_{W} + \beta_{RE1})}}$$
...
$$\mathbb{P}(\text{Fair | T=RE2, W=1)}= \frac{1}{1 + e^{- (\beta_{0} + \beta_{W} + \beta_{RE2})}}$$
