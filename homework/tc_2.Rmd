...
- No tienes conocimiento previo sobre la plausibilidad de tu hipótesis, de modo que le asignas un 50% de probabilidad de ser cierta: $\mathbb{P}(H_{1}  \text{ verdadera})=0.5$. Esto implica que también la hipótesis alternativa tiene la misma probabilidad de ser cierta: $\mathbb{P}(H_{0} \text{ verdadera})= 0.5$
...
Debes calcular las siguientes cantidades de interés:

1) La probabilidad de obtener un __"positivo verdadero"__, definido como:

$PV = \mathbb{P}(H_{1} \text{ verdadera} \mid \text{rechazar } H_{0})$


2) La probabilidad de obtener un __"falso positivo"__, definido como:

$FP = \mathbb{P}(H_{1} \text{ falso} \mid \text{rechazar } H_{0})$
