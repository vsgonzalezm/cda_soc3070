...
Podemos pensar en un modeo de regresión logística de la siguiente forma:
...
- $\beta_{1} \dots \beta_{k}$ son los respectivos "efectos" de los predictores sobre $p_{i}$
...
$p_{i} = \frac{e^{\eta_{i}}}{1 + e^{\eta_{i}}} = \frac{1}{1/e^{\eta_{i}} + 1}$

--

$\frac{1}{e^{\eta_{i}}} + 1 = \frac{1}{p_{i}}$


--

$\frac{1}{e^{\eta_{i}}} = \frac{1}{p_{i}} - 1 =  \frac{1 - p_{i}}{p_{i}}$
