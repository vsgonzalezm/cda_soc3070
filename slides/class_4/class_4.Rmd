...
### Binomial, ilustración via simulación
...
- Resultado muy conveniente para inferencia estadística
...
--
  ...
  - Recordar que   $\mathcal{L}(\boldsymbol{\beta} \mid \boldsymbol{X}) = \mathbb{P}(\boldsymbol{X} \mid \boldsymbol{\beta})$. Requiere especificar de antemano la distribución conjunta de las observaciones.
