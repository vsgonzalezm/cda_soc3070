...
.bold[Modelos estadísticos]:  ¿Cuáles son los valores más .bold[plausibles][1].footnote[[1] Notar que no dije "probabilidad"!] de los *parámetros* dado los *datos* que observamos? 
...
- $\mathcal{L}(p) = P(x_{1})P(x_{2}) \dots P(x_{n}) = p^{x}(1-p)^{n-k} \quad \text{   donde  } k= \sum x_{i}$
