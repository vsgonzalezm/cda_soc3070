...
mem = beta_ym*p_hat*(1-p_hat); mem # efector marginal para cada obs.
...
p_hat <- predict(logit_affairs_sex_ym2, newdata=grid, type="response") # prob predichas cada obs.
p_hat_delta <- predict(logit_affairs_sex_ym2, newdata=grid_delta, type="response") # prob predichas cada obs.

mem_ym = beta_ym*p_hat*(1-p_hat); mem_ym # efector marginal para cada obs.
