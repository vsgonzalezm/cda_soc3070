...
$\beta_{1} = \ln \mathbb{E}(\text{wage}_{i} \mid \text{male}=1) - \ln \mathbb{E}(\text{wage}_{i} \mid \text{male}=1) = \ln \frac{\mathbb{E}(\text{wage}_{i} \mid \text{male}=1)}{\mathbb{E}(\text{wage}_{i} \mid \text{male}=0)}$
--
...
.pull-left[
$$y_{i} ~ \mathcal{N}(\mu_{i},\sigma_{i}) \quad \text{ donde}$$
