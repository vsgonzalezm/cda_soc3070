...
<br>
Estructura general del una tabla 2-ways, $I \cdot J$
...
<br>
Estructura general de probabilidades en una  tabla 2-ways, $I \cdot J$
...
- Las frecuencias en cada celda son generadas por una variable Multinomial $X$ con $I \cdot 2$ posibles valores $ij$.
