...
.bold[Pregunta]:
Si la probabilidad de tener una aventura fuera independiente del género, cual sería la probabilidad de que, al seleccionar una persona al azar, encontremos una mujer que ha tenido un "affair"? 
]
]
