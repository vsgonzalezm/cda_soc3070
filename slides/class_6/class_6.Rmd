...
ci95_delta= c(ll=(delta - 1.96*se), ul=(delta + 1.96*se)); print(ci95_delta)
```
...
.pull-left[
$$\frac{\frac{\mathcal{N}(\mu_{1},\sigma_{1})}{1 - \mathcal{N}(\mu_{1},\sigma_{1})}}{\frac{\mathcal{N}(\mu_{2},\sigma_{2})}{1 - \mathcal{N}(\mu_{2},\sigma_{2})}}$$  
]
