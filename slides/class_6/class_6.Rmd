...
1) La diferencia de proporciones debe estar adecuadamente definida en términos de una variable dependiente y otra independiente, y su resultado depende de qué categoría es considerada como "éxito". La razón es que, en general:
...
- Parámetro de interés en el modelo más importante de datos categóricos: la regresión logística.

- $\theta$ está formulada para tablas de 2-por-2, pero también puede calcularse para tablas de mayor dimensión: toda tabla $n$-ways, $I \times J$, puede ser re-escrita como una serie  $(I-1) \times (J-1) \times (n-1)$ tablas de 2-por-2.
