...
Cada valor posible de una variable aleatoria tiene una cierta probabilidad de ocurrencia.
--
El conjunto de estas probabilidades se denomina la .bold[distribución] de la variable.
